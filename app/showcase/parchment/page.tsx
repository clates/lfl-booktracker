  ...
  return (
    <div className="min-h-screen bg-stone-100 p-8 space-y-12">
      <div className="max-w-6xl mx-auto text-center space-y-4">
        ...
        <p className="text-stone-600">A collection of paper and parchment styles for the BookTracker interface.</p>
      </div>
            ...
            <ParchmentFrame variant="default">
                <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <p className="text-stone-700 leading-relaxed font-serif">
                        "A clean, simple parchment style suitable for standard content containers, cards, and reading areas. 
                        It features a subtle texture and warm off-white color."
                    </p>
            ...
            <ParchmentFrame variant="ragged">
                 <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <p className="text-stone-700 leading-relaxed font-serif font-medium">
                        "Intended for loose notes, field scraps, or less formal content. 
                        The edges are irregular, suggesting a hand-torn piece of paper found in a pocket."
                    </p>
         ...
         <div className="space-y-4">
            ...
            <ParchmentFrame variant="ancient">
                 <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="text-2xl font-serif font-bold text-amber-950 uppercase tracking-widest">Ancient Scroll</h3>
                    <p className="text-amber-900/80 leading-relaxed font-serif text-lg">
                        "For historical records, legends, or significant milestones. 
                        This style is darker, heavily textured, and feels aged by centuries."
                    </p>
                </div>
            </ParchmentFrame>
        </div>
         ...
         <div className="space-y-4">
            ...
            <ParchmentFrame variant="decorated">
                 <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="text-2xl font-serif font-bold text-[#8a765a] border-b-2 border-[#bba588] pb-1">Royal Decree</h3>
                    <p className="text-[#6d5d48] leading-relaxed font-serif">
                        "A formal, high-status container with double borders and corner flourishes. 
                        Use this for achievements, official announcements, or primary feature highlights."
                    </p>
                </div>
            </ParchmentFrame>
        </div>
